...
def generate_report_stream(
    ...
    user_message = (
        ...
        f"### 요청 리포트 구조\n{sections}\n\n"
        "### 작성 지침\n"
        "1. 분량: A4 4~5쪽 분량(본문 5,000~7,000자)으로 충실하게 작성하세요.\n"
        "2. 제목 체계를 반드시 지키세요: 대제목 'Ⅰ.', 중제목 '1.', 소제목 '(1)'\n"
        "3. 리포트 맨 앞에 '# 제목'과 같은 문서 제목 줄을 절대 추가하지 마세요. 반드시 'Ⅰ.'로 바로 시작하세요.\n"
        "4. 정량 데이터가 있는 경우 반드시 마크다운 표(| 구분 | 내용 |)로 먼저 제시한 후 해석을 작성하세요.\n"
        "5. 문단 사이 빈 줄 없이 연속 서술하세요.\n"
        "6. 분석 결과에서 확인된 수치와 키워드를 구체적으로 인용하세요.\n"
        "7. 통계적으로 유의미한 결과는 반드시 강조하고 연구·정책적 의미를 제시하세요.\n"
        "8. 각 섹션을 빠짐없이 충실히 작성하고, 마지막 섹션까지 완결하세요."
    )
